(function () {
  ...
  var css = '#rr-booking-widget{position:fixed;bottom:24px;right:24px;z-index:600;display:flex;align-items:center;gap:8px;' +
    'background:#767E5D;color:#fdfcf8;text-decoration:none;padding:14px 22px;border-radius:8px;' +
    'font-family:\'Inter\',sans-serif;font-size:15px;font-weight:400;letter-spacing:-0.01em;' +
    'box-shadow:0 6px 24px rgba(51,36,29,0.3);transition:background 0.2s ease;}' +
    '#rr-booking-widget:hover{background:#5e6249;}' +
